...
PHASE4_RUN_FILES = [
    ...
    "runtime_canon_final.yaml", "phase4_validation.json",
]
...
def validate(workspace_root, output_root, mode="mock", project="price_tag_life"):
    ...
    for ch in chapters:
        ...
        if humanized_path.exists():
            ...
            quality_checks.append({"chapter": ch, "file": "humanized.md", "chars": char_count})
            if char_count < 800:
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="阶段四三章生产闭环验证")
